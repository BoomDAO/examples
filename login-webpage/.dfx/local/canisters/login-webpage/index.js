...
import { idlFactory } from './login-webpage.did.js';
export { idlFactory } from './login-webpage.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.LOGIN-WEBPAGE_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./login-webpage.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the login-webpage canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./login-webpage.did.js")._SERVICE>}
 */
export const login-webpage = createActor(canisterId);
