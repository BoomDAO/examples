...
const idleManager_1 = require("./idleManager");
const storage_1 = require("./storage");
var storage_2 = require("./storage");
Object.defineProperty(exports, "IdbStorage", { enumerable: true, get: function () { return storage_2.IdbStorage; } });
Object.defineProperty(exports, "LocalStorage", { enumerable: true, get: function () { return storage_2.LocalStorage; } });
Object.defineProperty(exports, "KEY_STORAGE_DELEGATION", { enumerable: true, get: function () { return storage_2.KEY_STORAGE_DELEGATION; } });
Object.defineProperty(exports, "KEY_STORAGE_KEY", { enumerable: true, get: function () { return storage_2.KEY_STORAGE_KEY; } });
var db_1 = require("./db");
Object.defineProperty(exports, "IdbKeyVal", { enumerable: true, get: function () { return db_1.IdbKeyVal; } });
...
__exportStar(require("./idleManager"), exports);
/**
...
class AuthClient {
    ...
    static async create(options = {}) {
        ...
        if (options.identity) {
            ...
            let maybeIdentityStorage = await storage.get(storage_1.KEY_STORAGE_KEY);
            if (!maybeIdentityStorage && storage_1.isBrowser) {
                // Attempt to migrate from localstorage
                try {
                    const fallbackLocalStorage = new storage_1.LocalStorage();
                    const localChain = await fallbackLocalStorage.get(storage_1.KEY_STORAGE_DELEGATION);
                    const localKey = await fallbackLocalStorage.get(storage_1.KEY_STORAGE_KEY);
                    // not relevant for Ed25519
                    if (localChain && localKey && keyType === ECDSA_KEY_LABEL) {
                        console.log('Discovered an identity stored in localstorage. Migrating to IndexedDB');
                        await storage.set(storage_1.KEY_STORAGE_DELEGATION, localChain);
                        await storage.set(storage_1.KEY_STORAGE_KEY, localKey);
                        maybeIdentityStorage = localChain;
                        // clean up
                        await fallbackLocalStorage.remove(storage_1.KEY_STORAGE_DELEGATION);
                        await fallbackLocalStorage.remove(storage_1.KEY_STORAGE_KEY);
                    }
                }
                catch (error) {
        ...
        if (key) {
            try {
                const chainStorage = await storage.get(storage_1.KEY_STORAGE_DELEGATION);
        ...
        const checkInterruption = () => {
            ...
            if (this._idpWindow) {
                if (this._idpWindow.closed) {
                    this._handleFailure(exports.ERROR_USER_INTERRUPT, options === null || options === void 0 ? void 0 : options.onError);
                }
                else {
...
async function _deleteStorage(storage) {
    await storage.remove(storage_1.KEY_STORAGE_KEY);
    await storage.remove(storage_1.KEY_STORAGE_DELEGATION);
    await storage.remove(storage_1.KEY_VECTOR);
}
