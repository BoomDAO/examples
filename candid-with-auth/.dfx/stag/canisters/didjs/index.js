...
import { idlFactory } from './didjs.did.js';
export { idlFactory } from './didjs.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DIDJS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./didjs.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the didjs canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./didjs.did.js")._SERVICE>}
 */
export const didjs = createActor(canisterId);
